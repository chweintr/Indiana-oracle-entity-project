...
- **Holographic LED rotor arrays:** good teaser near entrance, not primary head (operational noise, limited nuance at scale).  
...
- Decide if a teaser (holographic LED rotor display/LED sign) is part of scope.
