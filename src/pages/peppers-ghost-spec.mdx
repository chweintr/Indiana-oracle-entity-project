...
<div class="grid md:grid-cols-2 gap-8 my-8">
  <div>
    <img 
      src="/images/pepper_ghost_render.png" 
      alt="Detailed render showing Oracle figure projection and holographic effect through Pepper's Ghost illusion"
      class="w-full rounded-lg shadow-lg"
    />
    <p class="text-center text-sm text-gray-400 mt-2">
      <strong>Oracle Projection Render</strong> — Holographic figure appearance through foil reflection
    </p>
  </div>
  ...
  <div>
    <img 
      ...
      alt="Implementation setup showing physical installation components and spatial arrangement"
      class="w-full rounded-lg shadow-lg"
    />
    <p class="text-center text-sm text-gray-400 mt-2">
      <strong>Physical Setup</strong> — Installation components and spatial configuration
    </p>
  </div>
</div>
