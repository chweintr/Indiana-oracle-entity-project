...
<section style="all: revert; font-family: system-ui, sans-serif; background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 8px; padding: 24px; margin: 32px 0; color: #1e40af;">
<div>
...
<p class="text-sm mt-4" style="color: #1d4ed8 !important;">
