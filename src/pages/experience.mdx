...
**Morph** – When switching personas, the current entity dissolves into a "Fragments" particle swirl using Unreal Engine's Niagara system. During processing or persona transitions, particle animations fill latency gaps while the system loads the requested figure. The particles coalesce into the new persona, then disperse and reassemble when switching again.

**Release** – Ten seconds of silence or moving 1 meter laterally frees the microphone for the next visitor, maintaining crowd flow.
...
### Legal Framework & Estate Permissions

**Rights Clearance Process**: All celebrity personas require formal estate permissions and likeness rights before public deployment. Current legal review includes:

- **Vonnegut Estate**: Formal proposal submitted with revenue-sharing terms
- **Elinor Ostrom Estate**: Academic fair-use evaluation in progress  
- **Ryan White Foundation**: Collaboration discussions initiated
- **John Mellencamp**: Direct artist consultation planned

**IP Compliance**: All personas operate under strict content oversight with estate-approved dialogue boundaries. Legal counsel reviews all personality implementations for compliance with Indiana publicity rights statutes.

### Permissions & Estate Relations
