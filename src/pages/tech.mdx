...
- Video-to-video processing adds spectral, particle-like effects
- Real-time shaders create holographic appearance
- TouchDesigner overlays particle systems for ethereal quality

### 5. Live Display Output
The stylized video with alpha channel is:
- Processed through TouchDesigner for GPU effects
- Output to the holographic display system
- Seamlessly transitions between personas with particle scatter/gather animations
