...
- Individual units: **65-100 cm diameter** rotating LED arrays  
...
- Power: **2-3 kW** for full array system  
...
- **Refresh Rate**: 30-60 fps depending on content  
- **Color Depth**: 16.7 million colors  
- **Pixel Pitch**: 2.5-5mm depending on unit size  
...
- 2-4 synchronized units creating floating text and particles  
...
- 6-12 synchronized units for full 8ft figure  
...
- 4-6 units in flight cases  
- Quick setup/teardown (2-3 hours)  
