...
<div class="relative my-8">
  ...
  <p class="text-center text-sm text-gray-400 mt-4">
    <strong>Pipeline State Machine Visualization</strong> — Real-time demonstration of the conversational video pipeline showing state transitions between IDLE, SUMMON, TALK, and OUTRO states with particle effects and avatar rendering.
  </p>
</div>

This demo illustrates the visual flow of the Oracle Entity conversation system, showcasing:
- **State Transitions**: Smooth morphing between conversation phases
- **Particle Systems**: Dynamic environmental and persona-specific effects
- **Avatar Rendering**: Real-time head generation and dissolution
- **Visual Coherence**: Bookend poses ensuring seamless clip transitions
